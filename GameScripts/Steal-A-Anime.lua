...
-- ULTRA-FAST NOCLIP WITH INSTANT TELEPORT
-- ========================================
...
-- ========================================
-- ULTRA-FAST TELEPORT SYSTEM (ABSOLUTE ZERO DELAY)
-- ========================================
local function ultraFastTeleport(targetPosition)
    ...
    pcall(function()
        -- PHASE 1: INSTANT PHYSICS DISABLE (SINGLE FRAME)
        ...
        -- PHASE 2: INSTANT TELEPORT (ALL METHODS SIMULTANEOUSLY - NO DELAY)
        ...
        -- REDUNDANT POSITION SET (ENSURE SUCCESS)
        hrp.CFrame = CFrame.new(targetPosition)
        
        -- PHASE 3: INSTANT PHYSICS RE-ENABLE (SAME FRAME)
        for _, part in ipairs(NoclipData.Character:GetDescendants()) do
...
-- ========================================
-- ANTI-CHEAT SNAPBACK DETECTION SYSTEM
-- ========================================
...
-- Detect anti-cheat snapback (INSTANT DETECTION - NO DELAY)
...
local NoclipToggle = PlayerTab:Toggle({
    ...
    Desc = "Ultra-fast noclip with instant anti-cheat recovery!",
    Default = false,
    Callback = function(state)
        toggleNoclip(state)
    end
...
WindUI:Popup({
    ...
    Icon = "sword",
    Content = "New: ULTRA-FAST NOCLIP with instant anti-cheat recovery! Zero delay teleports!",
    Buttons = {
        {
            Title = "Close",
