...
local function tweenToBase()
    ...
    local function moveToBase()
        ...
        local baseTime = baseDistance / 30 -- 15 studs per second to base
        ...
        bodyVelocity.Velocity = direction * 30 -- 15 studs per second
    ...
    local function moveToCarpet()
        ...
        local carpetTime = carpetDistance / 30 -- 15 studs per second to carpet
