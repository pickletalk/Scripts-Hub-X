...
local function tweenToBase()
    ...
    local function moveToBase()
        ...
        local baseTime = baseDistance / 35 -- 15 studs per second to base
        ...
        bodyVelocity.Velocity = direction * 35 -- 15 studs per second
    ...
    local function moveToCarpet()
        ...
        local carpetTime = carpetDistance / 35 -- 15 studs per second to carpet
