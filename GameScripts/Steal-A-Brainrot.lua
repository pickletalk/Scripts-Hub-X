-- Steal A Brainrot UI + Teleporter + Infinite Jump + Fast Interaction + GodMode
-- by PickleTalk
...
local function enableGodMode()
    ...
    HealthConnection = hum.HealthChanged:Connect(function(h)
        if GodModeEnabled and h < math.huge then
            hum.Health = math.huge
        end
    end)
