-- ========================================
-- STEAL A ANIME - WINDUI HUB (FINAL)
...
print("Advanced Speed Spoofer Loaded Successfully!")
...
-- Speed Changer (WITH ADVANCED SPOOFER)
...
-- ========================================
-- OPTIMIZATIONS TAB FEATURES (LOW GFX FULLY FIXED)
-- ========================================
...
-- LOW GFX WITH PROPER SAVE/RESTORE (FULLY FIXED)
local function saveOriginalGFX()
    -- Save Lighting settings ONCE
...
-- ========================================
-- CREDITS TAB ELEMENTS (IMAGE URL METHOD)
-- ========================================
...
local CreditsParagraph = CreditsTab:Paragraph({
    ...
    Color = "Red",
    Thumbnail = "https://tr.rbxcdn.com/180DAY-a2e3410a82ca39bad9f802662ec9ca30/420/420/Image/Webp/noFilter",
    ThumbnailSize = 80,
    Buttons = {
        {
            Icon = "users",
